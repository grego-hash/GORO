...
DEVICE_TYPES_9899 = [
    ("98",     "Rim Exit Device (98)"),
    ("9927",   "Surface Vertical Rod (99/9927)"),
    ("9947",   "Concealed Vertical Rod (9947)"),
    ("9948",   "Concealed Vertical Rod Top+Bottom (9948)"),
    ("9957",   "Surface 3-Point Latch (9957)"),
    ("9949",   "Concealed Cable (9949)"),
    ("9950",   "WDC Cable (9950)"),
    ("XP98",   "Explosion Proof Rim (XP98/XP99)"),
]
...
DEVICE_ADDERS = {
    # 98 (Rim) has no adder (it IS the base)
    "9927":   [1037, 902, 1199, 1053, 1099, 1158, 1123, 1035, 1367],
    "9947":   [1194, 1045, 1223, 1196, 1173, 1231, 1174, 1178, 1445],
    "9948":   [1713, 1564, 1742, 1715, 1692, 1750, 1693, 1697, 1964],
    "9957":   [2190, 2055, 2352, 2206, 2252, 2311, 2276, 2188, 2520],
    "9949":   [1189, 1040, 1218, 1191, 1168, 1226, 1169, 1173, 1440],
    "9950":   [1417, 1274, 1441, 1412, 1385, 1433, 1428, 1368, 1685],
    "XP98":   [184, 184, 184, 184, 184, 184, 184, 184, 184],
}
...
def _seed_9899(conn):
    ...
    non_rim = [dv for dv, _ in DEVICE_TYPES_9899 if dv not in ("98", "XP98")]
    for dv in non_rim:
